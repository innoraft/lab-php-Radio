 ...
 */
if (!file_exists($file = '/var/www/html/srijeeta/Level3/vendor/autoload.php')) {
  throw new \Exception('please run "composer require google/apiclient:~2.0" in "' .'/var/www/html/srijeeta/Level3/api-samples/php/composer');
}

require_once '/var/www/html/srijeeta/Level3/vendor/autoload.php';
session_start();
 ...
 */
$OAUTH2_CLIENT_ID = '889679087710-fpjmatvn8ctn02jft7a6tk5877q2vui3.apps.googleusercontent.com';
$OAUTH2_CLIENT_SECRET = 'h24ah1SkNZWjD28rXfqgRtaS';
...
if ($client->getAccessToken()) {
  ...
  $_SESSION[$tokenSessionKey] = $client->getAccessToken();
} elseif ($OAUTH2_CLIENT_ID == '889679087710-fpjmatvn8ctn02jft7a6tk5877q2vui3.apps.googleusercontent.com') {
  $htmlBody = <<<END

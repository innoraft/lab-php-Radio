...
// print '<pre>';print_r($youtube);print '<pre>';

// Check if an auth token exists for the required scopes
$tokenSessionKey = 'token-' . $client->prepareScopes();
print '<pre>';print_r($tokenSessionKey);print '<pre>';
...
if ($client->getAccessToken()) {
  ...
  // 195495926744-ud8oh3gpij37tejdttq2e6trda7aqrsa.apps.googleusercontent.com
  $htmlBody = <<<END
